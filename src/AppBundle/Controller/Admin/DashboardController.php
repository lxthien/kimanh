...
class DashboardController extends Controller
{
    ...
    public function indexAction(SeoAnalyzer $seoAnalyzer)
    {
        ...
        $publishedPostCount = $this->countNewsBy(['postType' => 'post', 'enable' => 1]);
        $draftPostCount = $this->countNewsBy(['postType' => 'post', 'enable' => 0]);
